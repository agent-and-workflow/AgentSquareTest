...
from module_evolution.prompt_reasoning import get_init_archive_reasoning, get_prompt_reasoning
from module_evolution.prompt_planning import get_init_archive_planning, get_prompt_planning
from module_evolution.prompt_memory import get_init_archive_memory, get_prompt_memory
from module_evolution.prompt_tooluse import get_init_archive_tooluse, get_prompt_tooluse
...
def evolution(current_agent: dict[str, str], 
    ...
    system_prompt, prompt = get_prompt_reasoning(reasoning_archive)
    msg_list_reasoning = [
        {"role": "system", "content": system_prompt},
        {"role": "user", "content": prompt},
    ]
    
    system_prompt, prompt = get_prompt_planning(planning_archive)
    msg_list_planning = [
        {"role": "system", "content": system_prompt},
        {"role": "user", "content": prompt},
    ]
    
    system_prompt, prompt = get_prompt_memory(memory_archive)
    msg_list_memory = [
        {"role": "system", "content": system_prompt},
        {"role": "user", "content": prompt},
    ]
    
    system_prompt, prompt = get_prompt_tooluse(tooluse_archive)
    msg_list_tooluse = [
        {"role": "system", "content": system_prompt},
        {"role": "user", "content": prompt},
    ]
